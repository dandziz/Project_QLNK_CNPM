...
<body>
    ...
    <div class="main container" style="background-color: #f5f5f5;">
        ...
        if(isset($success)){
        ?>
        <small style="color: blue;"><?php echo $success ?></small>
        <?php
        }
        ?>
        <form method="POST" action="" class="form mt-5 ps-5 pe-5 pt-5 pb-5 container" id="form-1">
            ...
            <div class="form-content">
                ...
                <div class="row">
                    <div class="form-group mb-5 col-lg-12">
                        ...
                        <input id="fullname" name="fullname" type="text" placeholder="VD: Bình Nguyễn" class="form-control" required>
                        <span class="form-message"></span>
                    </div>
                    <div class="form-group mb-5 col-lg-6">
                        ...
                        <input id="address" name="address" type="text" placeholder="Phường/Quận/TP..." class="form-control" required>
                        <span class="form-message"></span>
                    </div>
                    <div class="form-group mb-5 col-lg-6">
                        <label for="address_now" class="form-label">Nơi ở hiện tại <span class="icon-required">(*)</span></label>
                        <input id="address_now" name="address_now" type="text" placeholder="Phường/Quận/TP..." class="form-control" required>
                        <span class="form-message"></span>
                    </div>
                    ...
                    <div class="form-group col-lg-4 mb-4">
                        ...
                        <input id="idcard" name="idcard" type="text" placeholder="" class="form-control" required>
                        <span class="form-message"></span>
                    </div>
                    <div class="form-group col-lg-4 mb-4">
                        <label for="idcard_address" class="form-label">Nơi cấp <span class="icon-required">(*)</span></label>
                        <input id="idcard_address" name="idcard_address" type="text" placeholder="" class="form-control" required>
                        <span class="form-message"></span>
                    </div>
                    <div class="form-group col-lg-4 mb-4">
                        <label for="idcard_date" class="form-label">Ngày cấp <span class="icon-required">(*)</span></label>
                        <input id="idcard_date" name="idcard_date" type="date" class="form-control" required>
                        <span class="form-message"></span>
                    </div>
                    <div class="form-group col-lg-6 mb-4">
                        <label for="email" class="form-label">Email</label>
                        <input id="email" name="email" type="text" placeholder="VD: binhnguyen123@gmail.com" class="form-control" required>
                        <span class="form-message"></span>
                    </div>
                </div>
                ...
                <div class="form-group mb-5">
                    ...
                    <input id="other" name="other" type="text" placeholder="Lý do" class="form-control" required>
                    <span class="form-message"></span>
                </div>
                ...
                <div class="form-group mb-5">
                    ...
                    <select id="feedback" name="feedback" class="form-control" required>
...
>>>>>>> 743565649389d859b4b9af64465661f754931e92:khaibaoOnline.php
                ...
                <button type="submit" class="form-submit btn btn-primary" name="btnSubmitTT">Ghi và gửi hồ sơ</button>
